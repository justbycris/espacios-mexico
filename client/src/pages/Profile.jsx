...
export default function Profile() {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      <h1 clsassName="text-3xl font-semibold text-center my-7">Profile</h1>
      <form className="flex flex-col ">
        <img src={currentUser.avatar} alt="Profile Picture." className='rounded-full h-24 w-24 object-cover self-center cursor-pointer mt-2'/>
        <input type="text" placeholder="username" id="username" className="border p-3 rounded-lg my-2" />
        <input type="text" placeholder="email" id="email" className="border p-3 rounded-lg my-2" />
